...
ALTER TABLE Pozajmica 
    ADD CONSTRAINT Pozajmica_PK PRIMARY KEY ( Nosnja_IdN, Clan_IdC, Clan_JmbgC, DatP ) ;
...
CREATE TABLE Vodi 
    ( 
     Sekcija_IdS       NUMBER  NOT NULL , 
     Sekcija_Kud_IdKud NUMBER  NOT NULL , 
     Koreograf_IdZ     NUMBER  NOT NULL 
    ) 
;

ALTER TABLE Vodi 
    ADD CONSTRAINT Vodi_PK PRIMARY KEY ( Sekcija_IdS, Sekcija_Kud_IdKud, Koreograf_IdZ ) ;
...
ALTER TABLE Vodi 
    ADD CONSTRAINT Vodi_Koreograf_FK FOREIGN KEY 
    ( 
     Koreograf_IdZ
    ) 
    REFERENCES Koreograf 
...
ALTER TABLE Vodi 
    ADD CONSTRAINT Vodi_Sekcija_FK FOREIGN KEY 
    ( 
     Sekcija_IdS,
     Sekcija_Kud_IdKud
    ) 
